...
import { Home, Luggage, Shirt, Sparkles } from "lucide-react";
export default function Layout() {
  const links = [["/", Home, "Accueil"], ["/wardrobe", Shirt, "Garde-robe"], ["/outfits", Sparkles, "Outfits"], ["/capsules", Luggage, "Capsules"]];
